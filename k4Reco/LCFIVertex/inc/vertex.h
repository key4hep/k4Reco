...
public:
  ...
  */
  Vertex(Event* Event, const std::vector<Track*>& Tracks, const Vector3& Position, const SymMatrix3x3& PosError,
  ...
  */
  ...
  //! Radius Error
  /*!
  Error of the distance from the vertex postion to the event's interaction point, taking into account the uncertainty in
  both the vertex and interaction point
  \param Proj Specifies projection of radius to be taken
  ...
  */
  ...
  /*!
  Error of the distance from the vertex postion to the other vertices position, taking into account the uncertainty in
  both vertices
  \param FarVertex Pointer to the other Vertex
  \param Proj Specifies projection of radius to be taken
