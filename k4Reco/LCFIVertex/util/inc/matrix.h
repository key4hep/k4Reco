...
namespace util {
  class SymMatrix2x2 : public boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
  ...
  public:
    // Default constructor
    Matrix2x2() : Base_Matrix(2, 2) {}
    Matrix2x2(const Matrix2x2&) = default;

    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    Matrix2x2(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  public:
    // Default constructor
    Matrix3x3() : Base_Matrix(3, 3) {}
    Matrix3x3(const Matrix3x3&) = default;

    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    Matrix3x3(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  public:
    // Default constructor
    Matrix5x5() : Base_Matrix(5, 5) {}
    Matrix5x5(const Matrix5x5&) = default;

    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    Matrix5x5(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  class SymMatrix6x6
      : public boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                       boost::numeric::ublas::row_major,
                                                       boost::numeric::ublas::bounded_array<double, 21>> {
    typedef boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                    boost::numeric::ublas::row_major,
                                                    boost::numeric::ublas::bounded_array<double, 21>>
        Base_Matrix;
  ...
  public:
    SymMatrix6x6() : Base_Matrix(6) {}
    SymMatrix6x6(const SymMatrix6x6&) = default;
    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    SymMatrix6x6(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  class Matrix6x6 : public boost::numeric::ublas::matrix<double, boost::numeric::ublas::row_major,
                                                         boost::numeric::ublas::bounded_array<double, 36>> {
    typedef boost::numeric::ublas::matrix<double, boost::numeric::ublas::row_major,
                                          boost::numeric::ublas::bounded_array<double, 36>>
        Base_Matrix;

  public:
    Matrix6x6() : Base_Matrix(6, 6) {}
    Matrix6x6(const Matrix6x6&) = default;
    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    Matrix6x6(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  class SymMatrix5x5
      : public boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                       boost::numeric::ublas::row_major,
                                                       boost::numeric::ublas::bounded_array<double, 15>> {
    typedef boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                    boost::numeric::ublas::row_major,
                                                    boost::numeric::ublas::bounded_array<double, 15>>
        Base_Matrix;
  ...
  public:
    SymMatrix5x5() : Base_Matrix(5) {}
    SymMatrix5x5(const SymMatrix5x5&) = default;
    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    SymMatrix5x5(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
  ...
  class SymMatrix3x3 : public boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                                      boost::numeric::ublas::row_major,
                                                                      boost::numeric::ublas::bounded_array<double, 6>> {
    typedef boost::numeric::ublas::symmetric_matrix<double, boost::numeric::ublas::lower,
                                                    boost::numeric::ublas::row_major,
                                                    boost::numeric::ublas::bounded_array<double, 6>>
        Base_Matrix;
  ...
  public:
    SymMatrix3x3() : Base_Matrix(3) {}
    SymMatrix3x3(const SymMatrix3x3&) = default;
    // Construction and assignment from a ublas matrix expression or copy assignment
    template <typename R>
    SymMatrix3x3(const boost::numeric::ublas::matrix_expression<R>& r) : Base_Matrix(r) {}
    // template<typename R> void operator=(const boost::numeric::ublas::matrix_expression<R>& r)
    // {
    //     Base_Matrix::operator=(r);
    // }
  ...
  **/
      ...
      while (ln >= low) {
        ...
        while (m >= l) {
          ...
          if (std::abs(H(m, m - 1)) * (std::abs(q) + std::abs(r)) <
              eps * (std::abs(p) * (std::abs(H(m - 1, m - 1)) + std::abs(z) + std::abs(H(m + 1, m + 1)))))
            break;
          --m;
        }
  ...
  public:
    ...
    */
    ...
    @return     V
    */
    inline void getV(boost::numeric::ublas::matrix<T>& M) { M = V; }

    /** Return the real parts of the eigenvalues
    @return     real(diag(D))
    */
    inline void getRealEigenvalues(boost::numeric::ublas::vector<T>& V) { V = d; }
    ...
    */
    inline void getImagEigenvalues(boost::numeric::ublas::vector<T>& V) { V = e; }
