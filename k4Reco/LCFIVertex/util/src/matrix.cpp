...
namespace util {
  ...
  Matrix3x3 InvertMatrix(Matrix3x3 a) // const ublas::matrix<T>& input, ublas::matrix<T>& inverse)
  {
    ...
    // std::cout << a << std::endl;
    // double det = a(0,0)*((a(1,1)*a(2,2))-(a(2,1)*a(1,2))) + a(0,1)*((a(1,2)*a(2,0))-(a(2,2)*a(1,0))) +
    // a(0,2)*((a(1,0)*a(2,1))-(a(2,0)*a(1,1)));

    double det = determinant(a);

    // std::cout << -a(0,2)*a(1,1)*a(2,0) << " " << a(0,1)*a(1,2)*a(2,0)  << " " <<  a(0,2)*a(1,0)*a(2,1)  << " " <<
    // a(0,0)*a(1,2)*a(2,1)  << " " <<  a(0,1)*a(1,0)*a(2,2)  << " " <<  a(0,0)*a(1,1)*a(2,2) << std::endl; std::cout <<
    // det << std::endl;
    Matrix3x3 inverse;
