...
struct JetConfig {
  ...
  JetConfig()
      : algo("DurhamVertex"), nJet(0), Ycut(1), useBeamJets(0), rParameter(1.0), alphaParameter(1.0),
        betaParameter(1.0), gammaParameter(1.0), coneR(0), epsCut(0), coreThreshold(0), distCut(0), nIteration(5),
        YaddVV(100), YaddVL(100), YaddLL(100), useMuonID(1), muonIDExternal(1), muonIDMinEnergy(5.), muonIDMinD0Sig(5.),
        muonIDMinZ0Sig(5.), muonIDMaxDist(5.), muonIDMinProb(.5) {}
};
...
public:
  ...
  static double funcVertex(Jet& jet1, Jet& jet2, double Evis2, JetConfig& cfg,
